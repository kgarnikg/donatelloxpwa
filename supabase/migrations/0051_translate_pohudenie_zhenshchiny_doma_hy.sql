...
begin
  ...
  set title_hy = 'Քաշի նվազեցում համար կանանց (տանը) — DonatelloX, տարեկան ծրագիր', description_hy = 'Քաշի նվազեցում համար կանանց (տանը) — DonatelloX, տարեկան ծրագիր. Սարքավորում. Հանտելներ, առաձգական ժապավեն տարբեր կոշտության, գորգիկ, կայուն հարթակ/աստիճան (ըստ հնարավորության)'
