/**
 * Универсальный видеоплеер-хелпер — видео может быть либо прямой ссылкой
 ...
 * YouTube достаёт ID видео, чтобы собрать чистый embed-URL. Используется
 * и в apps/web (видео к упражнениям), и здесь в apps/landing (ролик по
 * кнопке "Узнать больше").
 *
